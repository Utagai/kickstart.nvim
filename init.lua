...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>lp', builtin.find_files, { desc = '[S]earch [F]iles' })
      vim.keymap.set('n', '<leader>ss', builtin.builtin, { desc = '[S]earch [S]elect Telescope' })
      vim.keymap.set('n', '<leader>ls', builtin.live_grep, { desc = '[S]earch by [G]rep' })
      vim.keymap.set('n', '<leader>sd', builtin.diagnostics, { desc = '[S]earch [D]iagnostics' })
      vim.keymap.set('n', '<leader>lb', builtin.buffers, { desc = '[ ] Find existing buffers' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('ge', vim.lsp.buf.rename, 'Rename Hovered Symbol')
      ...
      statusline.setup {
        ...
        content = {
          active = function()
            ...
            -- Remove the filesize at the end
            fileinfo = fileinfo:gsub('%s%S+$', '') -- Remove filesize

            -- Remove the encoding (e.g., utf-8) and file format in square brackets (e.g., [unix])
            fileinfo = fileinfo:gsub('%S+%[%S+%]$', '') -- Remove 'utf-8[unix]' or similar parts
